...
<hr>
<div class="left-div"><h3>Name: <%=session.getAttribute("name").toString()%> </h3></div>
...
<div class="right-div-right"><h3>Payment Method: <%out.println("Cash On Delivery (COD)"); %> </h3></div>
